...
sys.path.append("/home/ubuntu/Holodeck")
# print(sys.path)
...
class Holodeck:
    ...
    def generate_small_objects(self, scene, used_assets=[]):
        ...
        print(f"Receptacle IDs: {receptacle_ids}")

        try:
            print("Generating small objects...")
            small_objects, receptacle2small_objects = self.small_object_generator.generate_small_objects(scene,
                                                                                                         controller,
                                                                                                         receptacle_ids)
            scene["small_objects"] = small_objects
            scene["receptacle2small_objects"] = receptacle2small_objects
            print("Small objects generated successfully.")
