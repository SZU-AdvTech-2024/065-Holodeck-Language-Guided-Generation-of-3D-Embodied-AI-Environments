...
from ai2holodeck.constants import (
    OBJATHOR_ANNOTATIONS_PATH,           # "~/Holodeck/data/2023_09_23/annotations.json.gz"
    HOLODECK_THOR_ANNOTATIONS_PATH,      # "~/Holodeck/data/holodeck/2023_09_23/thor_object_data/annotations.json.gz"
    OBJATHOR_FEATURES_DIR,               # "~/Holodeck/data/2023_09_23/features"
    HOLODECK_THOR_FEATURES_DIR,          # "~/Holodeck/data/holodeck/2023_09_23/thor_object_data"
)
...
class ObjathorRetriever:
    def __init__(
        ...
        # 加载CLIP特征，加载的内容存储在"objathor_clip_features_dict",包含objaverse的clip特征，包括图像特征img_features和唯一标识符uids等
        objathor_clip_features_dict = compress_pickle.load(
            os.path.join(OBJATHOR_FEATURES_DIR, f"clip_features.pkl")              # "~/Holodeck/data/2023_09_23/features/clip_features.pkl"
        )
        # 加载SBERT特征，加载的内容存储在"objathor_sbert_features_dict",包含objaverse的sbert特征，包括文本特征text_features和唯一标识符uids等
        objathor_sbert_features_dict = compress_pickle.load(
            os.path.join(OBJATHOR_FEATURES_DIR, f"sbert_features.pkl")             # "~/Holodeck/data/2023_09_23/features/sbert_features.pkl"
        )  # sbert features
        assert (
        ...
        thor_clip_features_dict = compress_pickle.load(
            os.path.join(HOLODECK_THOR_FEATURES_DIR, "clip_features.pkl")          # "~/Holodeck/data/holodeck/2023_09_23/thor_object_data/clip_features.pkl"
        )  # clip features
        thor_sbert_features_dict = compress_pickle.load(
            os.path.join(HOLODECK_THOR_FEATURES_DIR, "sbert_features.pkl")         # "~/Holodeck/data/holodeck/2023_09_23/thor_object_data/sbert_features.pkl"
        )  # clip features
