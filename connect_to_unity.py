...
parser.add_argument(
    ...
    default=os.path.join(
        # HOLODECK_BASE_DATA_DIR, "scenes/a_bedroom_with_two_beds-2024-08-08-15-56-26-466131/a_bedroom_with_two_beds.json"
        "ai2holodeck/data/scenes/a_bedroom_with_two_beds-2024-08-08-15-56-26-466131/a_bedroom_with_two_beds.json"
    ),
)
parser.add_argument(
    "--asset_dir",
